    ...
    if length == 0:
        ...
        if gen.isdigit():
            ...
            if gen == 1:
                ...
                print colored(" welcome Ms " + spy_name.upper() + " everything is ready to go ", 'magenta', 'on_white')
            else:
                print 'wrong choise'
                exit()
        else:
...
if spy_rating == 1 and spy_rating < 2:
    ...
    print spy_name + " Always ready for battle"
    ...
    exit()
spy_status = True
print " Welcome  " + spy_name.upper() + " REGISTER SUCESSFULLY " + " RECORD FOUND " \
...
STATUS_MESSAGES = ['Avaliable', 'Love','Sleeping','Not Available']
...
def start_chat(spy):
    ...
    if spy.age > 12 and spy.age < 50:
        ...
        print "Authentication complete. Welcome " + colored(spy.name, 'blue') + " age: " \
              + colored(str(spy.age), "red") + " and rating of: " + colored(str(spy.rating),
